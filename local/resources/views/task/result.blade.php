	...
	<body ng-cloak ng-controller="MainController">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div ng-controller="SubmitController as SubmitCtrl" ng-init="SubmitCtrl.getSubmits('{{$active}}', 0, 25); skip = 25; loadSubmit = '1'">
					...
					<ul class="nav nav-tabs">
						<li><a href="../task/"><b>รวมโจทย์</b></a></li>
					...
					<table class="table table-condensed table-hover" style="text-align:center">
						<thead>
							<tr>
								...
								<td ng-click="SubmitCtrl.sortSubmits('task.name')"><b><a href>โจทย์</a></b></td>
						...
						<tbody>
							...
							<tr ng-repeat="submit in SubmitCtrl.submits" ng-class="{'success': submit.pass == 1 && submit.task.visible == 1, 'warning invis': submit.task.visible != 1}">
								...
								<td><a href="../task/@{{submit.task.id}}">@{{submit.task.name}}</a></td>
					...
					<center><button ng-show="loadSubmit == '1'" ng-click="SubmitCtrl.getSubmits('{{$active}}', skip, 25); skip = skip + 25" class="btn btn-info">แสดงผลตรวจเพิ่มเติม</button></center><br>
