...
<html ng-app="mainApp">
	...
	<body ng-cloak>
		...
		<div class="container" ng-controller="MainController" ng-init="realTime(<?= time() ?>)">
			...
			<div class="row" ng-controller="PartialFeedbackController as ConCtrl" ng-init="ConCtrl.getContest('{{$contest_id}}'); ConCtrl.getTask('{{$contest_id}}', '{{$task_order}}')">
				<div class="col-md-8">
					...
					@endif
						<div class="panel panel-default">
							...
							<div class="panel-body" ng-show="ConCtrl.contest.status == 'running'">
								<form class="form-horizontal" method="post" action="{{ secure_url('contest/partial_feedback/active/upload') }}" enctype="multipart/form-data">
