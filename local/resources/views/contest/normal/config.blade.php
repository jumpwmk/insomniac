...
<html ng-app="mainApp">
	...
	<body ng-cloak>
		...
		<div class="container" ng-controller="MainController" ng-init="realTime(<?= time() ?>)">
			...
			<div class="row" ng-controller="NormalController as ConCtrl" ng-init="ConCtrl.getContest('{{$contest_id}}');">
				<div class="col-md-8" ng-init="ConCtrl.getTasks('{{$contest_id}}')">
					...
					<div class="panel panel-default panel-body">
						...
						<label>
							<input type="checkbox" ng-checked="ConCtrl.contest.data.full_feedback" ng-model="ConCtrl.contest.data.full_feedback">
							แสดงผลตรวจจากข้อมูลทดสอบจริง
						</label>
						| 
						<label>
							...
							<div class="modal-content">
								...
								<form>
									<div class="modal-body">
										...
										<hr ng-show="ConCtrl.curScore.info.pretestcase != '0'">
										<div ng-repeat="pretestcase in xrange(1,ConCtrl.curScore.info.pretestcase)" class="form-horizontal">
											<div class="col-sm-6">

												<label class="pull-right control-label">คะแนนตัวอย่างข้อมูลทดสอบที่ @{{pretestcase}}</label>
											</div>
											<div class="col-sm-6">

												<input type="number" class="form-control" ng-model="ConCtrl.curScore.data.score[$index + ConCtrl.curScore.info.testcase]" placeholder="จำนวนนับ หรือจำนวนจริง" required>
											</div>
											<br><br>
										</div>
									</div>
